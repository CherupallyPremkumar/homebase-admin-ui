...
// Seller modules have been registered in App.tsx
// We just filter out admin-only features

/**
 * SellerSidebar - Full shop management navigation for Sellers
 * Shows complete navigation with all product sub-menus, categories, etc.
 */
export function SellerSidebar() {
    ...
    const storeName = tenant ? tenant.charAt(0).toUpperCase() + tenant.slice(1) : 'My Shop';
